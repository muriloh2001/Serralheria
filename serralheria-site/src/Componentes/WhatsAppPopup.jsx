    ...
    <div className="fixed bottom-10 right-1 z-50 ">
      ...
      {!showPopup && (
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white px-2 py-2 rounded-lg shadow-lg flex items-center gap-3 animate-bounce transition duration-300 ease-in-out"
        >
          <FaWhatsapp size={28} />
      ...
      {showPopup && (
        <div className="relative">
          <div className="absolute bottom-10 right-0 w-80 bg-white border border-gray-200 shadow-2xl p-6 rounded-xl animate-fade-in">
            <h5 className=" font-bold mb-4 text-center text-gray-800 text-[1.12rem]">
              Escolha um Representante
            </h5>

            {/* Representante 1 */}
            <div className="mb-2">
              <div className="flex items-center gap-2 text-gray-800 text-[1.2rem]">
                <FaUserFriends /> Atendimento 1
              </div>
              <div className="flex items-center gap-2 text-green-600 text-[1.1rem]">
              ...
              <a
                ...
                className="mt-2 block text-center bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition text-[1.075rem]"
              >
                Enviar mensagem!
              </a>
            </div>
